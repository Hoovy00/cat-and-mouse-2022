...
class Mouse(object):
    ...
    START_Y_GRID = 3
    def __init__(self):
        self.x = (Screen.WIDTH/14*(Mouse.START_X_GRID-1)) + Board.line_WIDTH
        self.y = (Screen.HEIGHT/11*(Mouse.START_Y_GRID-1)) + Board.line_WIDTH
...
class Cat(object):
    ...
    START_Y_GRID = 10
    def __init__(self):
        self.x = (Screen.WIDTH/14*(Cat.START_X_GRID-1)) + Board.line_WIDTH
        self.y = (Screen.HEIGHT/11*(Cat.START_Y_GRID-1)) + Board.line_WIDTH
        self.speed = Player.VELOCITY
...
class Board(object):
    ...
    def draw(self):
        ...
        pygame.draw.rect(win, (COLOR_BACKGROUND), (0,0, W*14, H*11))
